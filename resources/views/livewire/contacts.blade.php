            ...
            <div class="grid gap-6 lg:gap-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="first-name" name="first-name" class="mt-2 block w-full px-4 py-3 border border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500" placeholder="John">
                    </div>
                    <div>
                        <label for="last-name" class="block text-sm font-medium text-gray-700">Last Name</label>
                        <input type="text" id="last-name" name="last-name" class="mt-2 block w-full px-4 py-3 border border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500" placeholder="Doe">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" class="mt-2 block w-full px-4 py-3 border border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500" placeholder="example@email.com">
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="company" name="company" class="mt-2 block w-full px-4 py-3 border border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500" placeholder="Your Company">
                    </div>
                    <div>
                        <label for="website" class="block text-sm font-medium text-gray-700">Company Website</label>
                        <input type="url" id="website" name="website" class="mt-2 block w-full px-4 py-3 border border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500" placeholder="https://yourcompany.com">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea id="message" name="message" rows="4" class="mt-2 block w-full px-4 py-3 border border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500" placeholder="Write your message here..."></textarea>
                </div>
            </div>
  
            <!-- Checkbox -->
            <div class="flex items-start mt-6">
                <input id="terms" name="terms" type="checkbox" class="h-4 w-4 border-gray-300 rounded text-blue-600 focus:ring-blue-500">
