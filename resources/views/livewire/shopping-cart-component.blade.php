<section>
    <div class="mx-auto max-w-3xl">
        <header class="text-center flex justify-center gap-3">
            <h1 class="text-xl font-bold sm:text-3xl bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-teal-400">
                Shopping Cart
            </h1>    
            ...
            <ul class="space-y-4">
                @foreach($cartItems as $item)
                    <li class="flex items-center gap-4">
                        <img src="images/ip13.png" alt="" class="size-16 rounded object-cover" />

                        <div>
                            <h3 class="text-sm text-gray-900">{{ $item->product->name }}</h3>
                            <dl class="mt-0.5 space-y-px text-[10px] text-gray-600">
                                <div>
                                    <dt class="inline">Seri:</dt>
            ...
            <div class="mt-8 flex justify-end border-t border-gray-100 pt-8">
                <div class="w-screen max-w-lg space-y-4">
                    ...
                    <div class="flex justify-end gap-2">
                        <a wire:navigate class="block rounded bg-purple-700 px-5 py-3 text-sm text-gray-100 transition hover:bg-blue-600" href="/">
                            Continue Shopping
                        </a>
